    ...
    return (
        <div className="p-5">
            ...
            <div className="flex justify-center space-x-4">
                <Link
                    href={!disablePrevious ? `/admin/penalties?page=${Math.floor(currentPage / maxPageButtons) * maxPageButtons - maxPageButtons + 1}` : "#"}
                    onClick={e => {
                        if (disablePrevious) {
                            e.preventDefault();
                        } else {
                ...
                {renderPageNumbers()}
                <Link
                    href={!disableNext ? `/admin/penalties?page=${Math.floor(currentPage / maxPageButtons) * maxPageButtons + maxPageButtons + 1}` : "#"}
                    onClick={e => {
                        if (disableNext) {
                            e.preventDefault();
                        } else {
