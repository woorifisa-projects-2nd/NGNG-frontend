...
export default function SearchKeyword() {
  ...
  useEffect(() => {
    const filterAndSort = () => {
      const filtedProducts: product[] = products.filter(
        (product) => selectdValue === "all" || product.category === selectdValue
      );
    ...
    <DefaultLayout>
      <div className="flex mx-auto justify-center p-2">
        <div className="flex-col mt-8">
          ...
          <div className="flex flex-wrap justify-between items-center gap-2">
                  ...
                  <button
                    ...
                    className={
                      forSale
                        ...
                        : "px-4 py-1 w-fit text-center text-[#272727] border border-[#272727] rounded active:border-point-color active:text-point-color active:border-2"
                    }
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              <button
                ...
                className="border rounded px-1 py-1 border-[#272727] active:border-point-color active:text-point-color"
              >
                적용
              </button>
            </div>
          ...
          {/*필터링 */}
          <div className="flex gap-4 justify-end mx-2 my-2">
            <div>
              <input
                type="radio"
                id="new"
